    ...
    <div class="size">
        <div class="form">
            ...
            <form action="">
                ...
                <input class="empty"  type="text" name="" id="" placeholder="Ms."><br></div>
                <div class="all">
                ...
                <input class="empty" style="margin-bottom: 10px;" type="text" name="" id="" placeholder="name@example.com"><br>
                </div>
                <div class="all">  <label for="">Address</label>
                <input class="empty" style="margin-bottom: 10px;" type="text" name="" id="" placeholder="7 Houndstooth Rd" ><br>
                </div>
                <div class="all"> <label for="">City</label>
                <input class="empty" style="margin-bottom: 10px;" type="text" name="" id="" placeholder="London" ><br></div>
                ...
                <input class="empty" style="margin-bottom: 10px;" type="text" name="" id="" placeholder="WG2 7LT" ><br></div>
...
"Bulgaria", "Burkina Faso", "Burundi", "Vietnam"
                ...
                <input class="empty" style="margin-bottom:10px;" type="text" name="" id="" placeholder="(234)234-2342" ><br></div>
                
                <div class="all"><label for="">Photo</label>
                <input class="empty" style="margin-bottom:10px;" type="text" name="" id="" placeholder="EmpID9.bmp" ><br></div>
                ...
                <div id="editor" cols="30" rows="10"></div>
                <script>
                        ClassicEditor
